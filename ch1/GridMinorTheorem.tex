...
\begin{document}
	...
	While the bound above is optimal for general graph products, some directions for future work include determining if there are better grid minor theorems for more specific classes of graphs or graph products. We also conjecture that for every integer $r\geq 1$ there is a tree $T$ of radius $r$ such that 
