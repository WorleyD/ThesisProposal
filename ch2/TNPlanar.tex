...
\begin{document}
	...
	A \defn{track layout} of a graph $G$ consists of a vertex colouring and a total order on each colour class, such that no two edges between any two colour classes cross.
